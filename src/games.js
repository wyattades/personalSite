export default [{
  ...
  id: 'warmvector',
  title: 'WarmVector',
  desc: 'Shooting bad guys, randomly generated levels, destructable terrain. Created with my own 2D game engine',
}, {
  url: 'https://wyattades.github.io/inf-p2p',
  id: 'inf-p2p',
  title: 'Infinite World',
  desc: 'First-person, infinite random terrain, HTML. It\'s cool just click it',
}, {
  id: 'arc-dodger',
  title: 'Arc Dodger',
  desc: 'Colorful arcs are comin\', and they\'re comin\' strong',

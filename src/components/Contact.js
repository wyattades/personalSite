...
export default () => (
  <AnimatedPage className="content">
    <h1>Contact</h1>
    <p>
      <a href="mailto:wyattades@gmail.com">
        <i className="fa fa-envelope head" />
        wyattades@gmail.com
      </a>
    </p>
    <h1>Other Links</h1>

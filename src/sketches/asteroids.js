...
// The source code was converted from Java (specifically Processing)
// using npm module `java-to-javascript`

// Java ArrayList Polyfill
...
// This code was converted from Java (specifically Processing) using npm module `java-to-javascript`

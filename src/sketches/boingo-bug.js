export default (p5, width, height) => {
  ...
  class Bug {
    ...
    display() {
      ...
      p5.fill(255);
      p5.noStroke();
      p5.ellipse(this.x + 3, this.y - 2, 12, 12);
      p5.noStroke();
      p5.fill(255);
      p5.rect(this.x + 12, this.y + 6, 6, 4);
      p5.strokeWeight(4);
      p5.stroke(0);
      p5.line(this.x + 8, this.y - 14, this.x + 15, this.y - 18);
      p5.line(this.x + 20, this.y - 14, this.x + 15, this.y - 18);
      p5.line(this.x, this.y - 14, this.x + 2, this.y - 20);
      p5.line(this.x + 9, this.y - 24, this.x + 2, this.y - 20);
      p5.strokeWeight(1);
      p5.stroke(200);
      if (flap === true) {
      ...
      if (dead === true) {
        p5.stroke(0);
        p5.strokeWeight(2);
        p5.line(this.x, this.y - 5, this.x + 6, this.y + 1);
        p5.line(this.x + 6, this.y - 5, this.x, this.y + 1);
      }
      if (dead === false) {
        p5.noStroke();
        p5.fill(0);
        p5.ellipse(this.x + 4, this.y - 2, 7, 7);
      }
    }
    jump() {
      this.boing = true;

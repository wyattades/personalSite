  ...
  <section key="edu" className="pad-horizontal">
    <div>
      ...
      <p className="item-desc">
        Earned &ldquo;A&rdquo; grade and had the role of Project Lead in the
        following major programming projects: Web Development Capstone, Software
